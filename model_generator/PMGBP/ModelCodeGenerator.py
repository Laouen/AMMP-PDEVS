...
ATOMIC = pkg_resources.resource_filename(__name__, 'templates/atomic.tpl.hpp')
COUPLED = pkg_resources.resource_filename(__name__, 'templates/coupled.tpl.hpp')
ENZYME_SET = pkg_resources.resource_filename(__name__, 'templates/enzyme_set.tpl.hpp')
