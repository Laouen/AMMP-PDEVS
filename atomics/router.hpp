    ...
    namespace models {
        ...
        public:
            ...
            void internal_transition() {
                ...
                pmgbp::map<PORTS::output_type>(this->_state.output, router::clear_bag);
            ...
            TIME time_advance() const {
                ...
                if (!pmgbp::empty(this->_state.output)) {
        ...
        private:
            ...
            void push_to_correct_port(const PORTS::output_type& message) {
                ...
                pmgbp::get<PORTS::output_type>(this->_state.output, port_num).emplace_back(message);
            }
        };
